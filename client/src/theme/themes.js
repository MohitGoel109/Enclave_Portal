export const THEMES = [
  {
    ...
    particle: "ember", particleColor: ["#ffd23f", "#ff6a1a"],
    extras: ["rays"], touchShape: "flame",
  },
  {
    ...
    particle: "rain", particleColor: ["#8fe9f0", "#2ec4d6"],
    extras: ["waves"], touchShape: "ripple",
  },
  {
    ...
    particle: "spark", particleColor: ["#fffbe0", "#f5e642"],
    extras: ["lightning"], touchShape: "zap",
  },
  {
    ...
    particle: "spore", particleColor: ["#c9f27a", "#7fd13b"],
    extras: ["fireflies"], touchShape: "orb",
  },
  {
    ...
    particle: "pulse", particleColor: ["#ff9df0", "#e64fd9"],
    extras: ["rings", "equalizer"], touchShape: "wave",
  },
  {
    ...
    particle: "haze-drift", particleColor: ["#dfe4ee", "#a8b0c0"],
    extras: ["godrays"], touchShape: "puff",
  },
  {
    ...
    particle: "dust", particleColor: ["#e8c48a", "#c98a3f"],
    extras: ["cracks", "tremor"], touchShape: "chip",
  },
  {
    ...
    particle: "petal", particleColor: ["#ffd6e4", "#ff8fb3"],
    extras: ["bloom", "pollen"], touchShape: "petal",
  },
  {
    ...
    particle: "heart", particleColor: ["#ff8095", "#e6304f"],
    extras: ["heartbeat"], touchShape: "heart",
  },
];
